 ...
 * 创建角色请求 DTO
 *
 * <p><b>需求描述：</b>大王要求参考 nest-admin CreateRoleDto 实现创建角色请求参数</p>
 * <p><b>解决方案：</b>角色 DTO，包含基本信息 + 菜单权限ID列表</p>
 * <p><b>原因说明：</b>对应 nest-admin CreateRoleDto。menuIds 和 permissionIds 用于关联角色与菜单/权限</p>
 */
@Data
