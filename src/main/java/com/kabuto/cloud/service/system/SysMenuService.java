...
public interface SysMenuService {
     ...
     * 分页查询菜单树形列表
     */
    PageResult<MenuVO> pageTree(Integer pageNum, Integer pageSize, SearchMenuDTO dto);
     ...
     * 启停菜单状态
     */
    void changeStatus(Long menuId, Integer status);
