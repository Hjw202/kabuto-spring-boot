 ...
 * <p><b>解决方案：</b>定义认证相关服务接口，包含登录、登出、获取路由、获取用户信息。
 * Service 层只返回业务数据，不包装 R；R 包装由 Controller 层负责</p>
 * <p><b>原因说明：</b>对应 nest-admin AuthService。接口层定义契约，实现层处理具体业务逻辑。
 * 业务异常通过 BizException 抛出，由 GlobalExceptionHandler 统一处理</p>
 */
public interface AuthService {
     ...
     */
    LoginVO login(LoginUserDTO dto, String ip, String userAgent);
